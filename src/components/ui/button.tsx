...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-lg hover:bg-primary-glow hover:shadow-glow transform hover:-translate-y-0.5",
        destructive:
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-glow-intense transform hover:-translate-y-1 font-bold uppercase tracking-wider px-8 py-4",
        cta: "bg-primary text-primary-foreground shadow-glow hover:shadow-glow-intense hover:bg-primary-glow transform hover:scale-105 font-semibold",
      },
      size: {
